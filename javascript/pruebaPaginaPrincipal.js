class peliculas{
    constructor(nombre,destacada,srcImage,description,categories,released,trailerLink){
        this.nombre=nombre
...
let peliculaDestacada=new peliculas("Transformes",true,"./assets/Posters de peliculas/pel5.jpg","Em la nuva de transforme todo muere pibe","Accion Aventura",true,"https://www.youtube.com/watch?v=dQw4w9WgXcQ")
